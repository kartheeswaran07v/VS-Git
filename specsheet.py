...
def createSpecSheet(case_data, units, other):
    ...
    worksheet.write('A10', '')
    worksheet.write('A11', 'Fluid State / Name')
    worksheet.write('A12', 'Service Description')
    ...
    worksheet.write('B11', '')
    worksheet.write('B12', '')
    worksheet.write('B13', 'Valve Sizing Calculation', bold)
    ...
    worksheet.write('B18', 'Specific Gravity', cell_format)
    worksheet.write('B19', 'Kinematic Viscosity', cell_format)
    worksheet.write('B20', 'Vapour Pressure', cell_format)
    worksheet.write('B21', 'Liquid Pr. Recovery factor, Fl', cell_format)
    ...
    worksheet.write('B54', 'Cv @90 Degree / Characteristic', cell_format1)
    worksheet.write('B55', 'Shaft Material', cell_format1)
    worksheet.write('B56', 'Flow Direction', cell_format1)
    worksheet.write('B57', 'Disc Material', cell_format1)
    worksheet.write('B58', 'Seat Material', cell_format1)
    ...
    worksheet.write('C2', '')
    worksheet.write('C3', '')
    worksheet.write('C4', case_data[0][-1], cell_format)
    ...
    worksheet.write('C10', '')
    worksheet.write('C11', 'Liquid / Fuel Oil Gr1 / Bitumen')
    worksheet.write('C12', 'Mixing')
    ...
    worksheet.write('D11', '')
    worksheet.write('D12', '')
    worksheet.write('D13', 'Case1', bold)
    ...
    worksheet.write('G10', '')
    worksheet.write('G11', 'Critical Pressure')
    worksheet.write('G12', 'Shutoff Pressure')
    worksheet.write('G13', 'Case3', bold)
    ...
    worksheet.write('H2', '')
    worksheet.write('H3', '')
    worksheet.write('H4', str(case_data[0][-3]), cell_format)
    worksheet.write('H5', str(case_data[0][-2]), cell_format)
    worksheet.write('H6', '', cell_format)
    worksheet.write('H7', str(case_data[0][-11]), cell_format)
    worksheet.write('H8', '', cell_format)
    worksheet.write('H9', case_data[0][-10], cell_format)
    worksheet.write('H10', '')
    worksheet.write('H11', '')
    worksheet.write('H12', '')
    worksheet.write('H13', 'Case4', bold)
    ...
    worksheet.insert_image('J1', 'logo.png', {'x_scale': 0.5, 'y_scale': 0.5})
    worksheet.write('J2', '')
    worksheet.write('J3', '')
    ...
    worksheet.merge_range('G30:L30', "Actuator Data", bold)

    worksheet.merge_range('B30:E30', "Pipe Line Data", bold1)
    worksheet.merge_range('B36:E36', "Valve Body & Bonnet", bold1)
    worksheet.merge_range('B52:E52', "Valve Trim", bold1)
    ...
    worksheet.merge_range('G55:L55', "Testing, Certification, Cleaning, Painting", bold)
    worksheet.merge_range('G42:L42', "Testing, Certification, Cleaning, Painting", bold)
    ...
    worksheet.merge_range('E13:F13', "Case2", bold)
    ...
    worksheet.merge_range('I13:J13', "Case5", bold)
    ...
    worksheet.merge_range('K13:L13', "Case6", bold)
    ...
    worksheet.merge_range('K31:L31', "", br)
    ...
    worksheet.merge_range('K53:L53', "", br)

    worksheet.merge_range('I54:J54', "", cell_format1)
    worksheet.merge_range('K54:L54', "", br)

    worksheet.merge_range('I56:J56', "", cell_format1)
    worksheet.merge_range('K56:L56', "", br)

    worksheet.merge_range('I57:J57', "", cell_format1)
    worksheet.merge_range('K57:L57', "", br)

    worksheet.merge_range('I58:J58', "", cell_format1)
    worksheet.merge_range('K58:L58', "", br)

    worksheet.merge_range('I59:J59', "", cell_format1)
    worksheet.merge_range('K59:L59', "", br)

    worksheet.merge_range('I60:J60', "", cell_format1)
    worksheet.merge_range('K60:L60', "", br)

    worksheet.merge_range('I61:J61', "", cell_format1)
    worksheet.merge_range('K61:L61', "", br)

    worksheet.merge_range('A73:D73', "FLOW CONTROL COMMUNE PVT LTD")
    worksheet.merge_range('J73:L73', "QMS/AE/002", f1)

    worksheet.merge_range('C1:H1', "")
    worksheet.merge_range('B62:I62', "Notes", bold)
    worksheet.merge_range('B63:I63', "N1- MPI-Body/Bnt Castings/Forgings to ASME B16.34 at Foundry/Forge", cell_format)
    ...
    worksheet.merge_range('J62:L62', "Revison Control", bold)
    ...
    # add data
    worksheet.write('C4', str(case_data[0][-1]), cell_format)
    worksheet.write('C11', str(case_data[0][16]), cell_format)
    worksheet.write('H4', str(case_data[0][22]), cell_format)
    worksheet.write('H5', str(case_data[0][23]), cell_format)
    worksheet.write('H7', str(case_data[0][14]), cell_format)
    worksheet.write('H9', str(case_data[0][15]), cell_format)
    worksheet.write('C31', str(case_data[0][18]), cell_format)
    worksheet.write('C32', str(case_data[0][19]), cell_format)

    column_dict_tuple = [('D', 0), ('E', 1), ('G', 2), ('H', 3), ('I', 4), ('K', 5)]
    len_cases = len(case_data)
    if len_cases > 6:
        len_cases = 6
    for i in column_dict_tuple[:len_cases]:
        for j in range(14):
            worksheet.write(f'{i[0]}{j+14}', case_data[i[1]][j], cell_format)
    for j in range(14):
        worksheet.write(f'C{j + 14}', units[j], cell_format)
    worksheet.write(f'D31', units[-1], cell_format)
    worksheet.write(f'D32', units[-2], cell_format)

    # other values input
    worksheet.write(f'H6', other[0], cell_format)
    worksheet.write(f'H8', other[1], cell_format)
    worksheet.write(f'C5', other[2], cell_format)
    worksheet.write(f'I11', other[3], cell_format)
    worksheet.write(f'J11', other[4], cell_format)
    worksheet.write(f'I12', other[5], cell_format)
    worksheet.write(f'C38', other[6], cell_format)
    worksheet.write(f'D38', other[7], cell_format)
    worksheet.write(f'E38', other[8], cell_format)
    worksheet.write(f'C40', other[9], cell_format)
    worksheet.write(f'C44', other[10], cell_format)
    worksheet.write(f'C47', other[11], cell_format)
    worksheet.write(f'C48', other[12], cell_format)
    worksheet.write(f'C50', other[13], cell_format)
    worksheet.write(f'C53', other[14], cell_format)
    worksheet.write(f'C56', other[15], cell_format)
    worksheet.write(f'C58', other[16], cell_format)
    worksheet.write(f'C57', other[17], cell_format)
    worksheet.write(f'C59', other[18], cell_format)
    worksheet.write(f'C41', other[19], cell_format)
    worksheet.write(f'C42', other[20], cell_format)
...
def createActSpecSheet(act_data, proj_data):
    ...
    workbook = xlsxwriter.Workbook(f'C:\\Users\\FCC\\Desktop\\Act_Specsheet_{a_}.xlsx')
    worksheet = workbook.add_worksheet()
    ...
    worksheet.write('A30', '17', cell_format2)
    worksheet.write('A31', '18', cell_format2)
    worksheet.write('A32', 'BB', boldc)
    ...
    worksheet.write('B30', 'Fluid Negative Gradient', cell_format1)
    ...
    worksheet.insert_image('H1', 'logo.jpg', {'x_scale': 0.7, 'y_scale': 0.6})
    worksheet.write('H2', '', )
    worksheet.write('H3', '', )
    ...
    worksheet.write('I41', '', cell_format2)
    ...
    worksheet.merge_range('F13:G13', 'Actuator Details', bold)
    ...
    worksheet.merge_range('F30:G30', 'Max Top/Side Mount HW Thrust', cell_format)
