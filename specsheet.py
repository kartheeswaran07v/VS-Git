...
def createSpecSheet(case_data, units, other, act_):
    ...
    for i in range(len(case_data)):
        ...
        worksheet.insert_image('A4', 'static\images\Fcc logo.png', {'x_scale': 0.5, 'y_scale': 0.5})
        ...
        worksheet.write('C11', str(case_data[i][0][16]), f1)
        ...
        worksheet.write(f'C38', other[i][6], f1)
        worksheet.write(f'D38', other[i][7], cell_format1)
        worksheet.write(f'E38', other[i][8], f1)
